/*
	...
	Description:
	Used a refresher for the vehicle inventory / Container menu items.
*/
...
_data = _veh getVariable ["Container",[]];
if(count _data == 0) then {_veh setVariable["Container",[[],0],true]; _data = [];} else {_data = _data select 0;};
